...
## [4) Algunos Atributos Globales:](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes)
...
* [```<audio>``` Insertar Audio](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/audio)
